<?php
	...
	class Dinozoom_Customizer_API_Wrapper {
		...
		public function enqueue_scripts() {
			wp_enqueue_style( 
				'corporatebusiness-cutomizer-css', 
			...
			wp_enqueue_style( 
				'corporatebusiness-font-awesome', 
				get_template_directory_uri() . '/inc/font-awesome/css/font-awesome.min.css', 
				array()
			);
			wp_enqueue_script( 
				'corporatebusiness-customizer-js', 
				get_template_directory_uri() . '/inc/admin/js/script.js',
				array('jquery'),
				$this->_version,
				true
			);
			wp_localize_script( 'customizer-js', 'corporatebusiness_upgrade', array( 'message' => __( 'Upgrade to Pro', 'corporatebusiness' ) ) );
		}
